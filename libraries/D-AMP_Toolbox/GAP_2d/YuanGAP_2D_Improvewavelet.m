...
filename = 'lena';
X2D = im2double(imread([filename '.png']));
figure; imshow(X2D);
Row = 128;
Col  =128;
...
[theta_wL21_dwt_tree model_wL21_dwt_tree] = GAP_2D_wL21_tree(y, P, Phi, row,col, block,'wavelet', m_star,stopc,acc);
...
PSNR_wL21_dwt_tree = SS_PSNR_3D(X2D,theta_2d_wL21_dwt_tree);

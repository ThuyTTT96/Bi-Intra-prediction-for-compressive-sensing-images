function [x_tplus1,z_tplus1,pseudo_data] = DAMP_oneIter(y,z_t,x_t,width,height,denoiser,M_func,Mt_func)
% function x_hat = DAMP_oneIter(y,z_t,x_t,width,height,denoiser,M_func,Mt_func)
% This function computes one iteration of the D-AMP algorithm
% Input:
%       y       : the measurements
...
z_tplus1=y-M(x_tplus1)+1/m.*z_t.*div;
end
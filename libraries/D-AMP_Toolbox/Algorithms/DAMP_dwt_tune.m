function x_hat = DAMP_dwt_tune(y,iters,width,height,denoiser,M_func,Mt_func)
...
denoi=@(noisy,sigma_hat) denoise_tune_dwt(noisy,sigma_hat,width,height,denoiser);
...
%      disp(['DAMP, iter ' num2str(i)  ', PSNR: ' num2str(PSNR_iter)]);
    eta=randn(1,n);

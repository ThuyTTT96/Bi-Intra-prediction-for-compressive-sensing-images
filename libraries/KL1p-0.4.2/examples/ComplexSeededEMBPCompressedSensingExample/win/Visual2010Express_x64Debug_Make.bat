...
SET COMPILERNAME="Visual Studio 10 Win64"
SET PROJECT_NAME=ComplexSeededEMBPCompressedSensingExample
...
SET FINALPROJECT_PATH=%COMPILER%Express_%PLATFORM%%BUILDTYPE%\
